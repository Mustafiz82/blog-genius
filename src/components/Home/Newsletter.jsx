...
export default function Newsletter() {
    ...
    return (
        <div className="relative my-10 bg-white shadow-lg rounded-lg py-14 p-8 mx-10">
            {/* Title & Subtitle */}
            ...
            <div className="flex items-center mt-4 space-x-2">
                <input
                    ...
                    className="flex-grow p-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                <button
            ...
            {/* Decorative Elements */}
            <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 via-purple-500 to-green-400"></div>
